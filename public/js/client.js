...
const ODD_ONE_OUT_POOL = [
  ...
  { group: ['hat', 'scarf', 'gloves'], odd: 'spatula' },
  { group: ['sock', 'shoe', 'boot'], odd: 'pancake' },
  { group: ['rain', 'snow', 'hail'], odd: 'trombone' },
  { group: ['pizza', 'burger', 'taco'], odd: 'lighthouse' },
  { group: ['bottle', 'cup', 'mug'], odd: 'hedgehog' },
  { group: ['hammer', 'screwdriver', 'wrench'], odd: 'strawberry' },
  { group: ['bus', 'truck', 'car'], odd: 'toothbrush' },
  { group: ['ear', 'eye', 'nose'], odd: 'bicycle' },
  { group: ['shampoo', 'soap', 'toothpaste'], odd: 'watermelon' },
  { group: ['salt', 'pepper', 'paprika'], odd: 'raincoat' },
  { group: ['milk', 'juice', 'water'], odd: 'pillowcase' },
  { group: ['baseball', 'football', 'soccer'], odd: 'cactus' },
  { group: ['violin', 'cello', 'piano'], odd: 'snowflake' },
  { group: ['Monday', 'Friday', 'Sunday'], odd: 'microscope' },
  { group: ['candle', 'lantern', 'flashlight'], odd: 'spaghetti' },
  { group: ['eagle', 'sparrow', 'penguin'], odd: 'calculator' },
  { group: ['banana', 'grape', 'peach'], odd: 'screw' },
  { group: ['gold', 'silver', 'bronze'], odd: 'mustard' },
  { group: ['circle', 'square', 'triangle'], odd: 'kangaroo' },
  { group: ['river', 'lake', 'ocean'], odd: 'headphones' },
  { group: ['shirt', 'pants', 'jacket'], odd: 'sunscreen' },
  { group: ['pasta', 'rice', 'bread'], odd: 'stapler' },
  { group: ['bear', 'wolf', 'fox'], odd: 'teacup' },
  { group: ['carrot', 'broccoli', 'spinach'], odd: 'snowman' },
  { group: ['airplane', 'helicopter', 'rocket'], odd: 'omelet' },
  { group: ['keyboard', 'mouse', 'monitor'], odd: 'pineapple' },
  { group: ['north', 'south', 'east'], odd: 'sandcastle' },
  { group: ['tick', 'tock', 'clock'], odd: 'avocado' },
  { group: ['camera', 'photo', 'video'], odd: 'mitten' },
  { group: ['summer', 'autumn', 'winter'], odd: 'frying pan' },
  { group: ['mirror', 'window', 'glass'], odd: 'octopus' },
  { group: ['pillow', 'blanket', 'sheet'], odd: 'microwave' },
  { group: ['monkey', 'gorilla', 'chimpanzee'], odd: 'tulip' },
  { group: ['pencil', 'eraser', 'sharpener'], odd: 'air conditioner' },
  { group: ['tea', 'coffee', 'soda'], odd: 'snowboard' },
];

const TRIVIA_POOL = [
  // Harder pool (pub-trivia vibe). Keep answers unambiguous.
  { q: 'What is the most abundant gas in Earth’s atmosphere?', choices: ['Oxygen', 'Nitrogen', 'Carbon dioxide', 'Argon'], a: 1 },
  { q: 'What is the chemical symbol for tungsten?', choices: ['Tg', 'W', 'Tu', 'Ts'], a: 1 },
  { q: 'Which planet has the shortest day (fastest rotation)?', choices: ['Mars', 'Jupiter', 'Earth', 'Neptune'], a: 1 },
  { q: 'Which country has the most time zones (including overseas territories)?', choices: ['Russia', 'United States', 'France', 'China'], a: 2 },
  { q: 'In what year did the Berlin Wall fall?', choices: ['1987', '1989', '1991', '1993'], a: 1 },
  { q: 'Which river flows through Budapest?', choices: ['Rhine', 'Danube', 'Seine', 'Po'], a: 1 },
  { q: 'What is the capital of Kazakhstan?', choices: ['Almaty', 'Astana', 'Tashkent', 'Bishkek'], a: 1 },
  { q: 'Which element has atomic number 26?', choices: ['Cobalt', 'Nickel', 'Iron', 'Copper'], a: 2 },
  { q: 'What is the smallest prime number greater than 100?', choices: ['101', '103', '107', '109'], a: 0 },
  { q: 'What is the SI unit of electric resistance?', choices: ['Watt', 'Ohm', 'Volt', 'Ampere'], a: 1 },
  { q: 'What is the boundary around a black hole called, beyond which nothing can escape?', choices: ['Photon sphere', 'Event horizon', 'Singularity', 'Accretion disk'], a: 1 },
  { q: 'Which language family does Hungarian belong to?', choices: ['Slavic', 'Romance', 'Uralic', 'Germanic'], a: 2 },
  { q: 'Which composer wrote the “Moonlight Sonata”?', choices: ['Mozart', 'Beethoven', 'Chopin', 'Bach'], a: 1 },
  { q: 'What is the currency of South Korea?', choices: ['Yen', 'Won', 'Yuan', 'Ringgit'], a: 1 },
  { q: 'What is the longest bone in the human body?', choices: ['Tibia', 'Femur', 'Humerus', 'Fibula'], a: 1 },
  { q: 'Which ocean current is best known for warming Western Europe?', choices: ['Canary Current', 'Gulf Stream', 'Kuroshio Current', 'Benguela Current'], a: 1 },
  { q: 'Which moon is the largest in the Solar System?', choices: ['Titan', 'Ganymede', 'Europa', 'Callisto'], a: 1 },
  { q: 'What does the “D” stand for in DNA?', choices: ['Deoxy', 'Double', 'Dynamic', 'Dextro'], a: 0 },
  { q: 'Which painter is associated with the work “Guernica”?', choices: ['Salvador Dalí', 'Pablo Picasso', 'Joan Miró', 'Henri Matisse'], a: 1 },
  { q: 'Who wrote “One Hundred Years of Solitude”?', choices: ['Jorge Luis Borges', 'Gabriel García Márquez', 'Isabel Allende', 'Mario Vargas Llosa'], a: 1 },
  { q: 'What is the term for a word that reads the same forwards and backwards?', choices: ['Palindrome', 'Anagram', 'Homonym', 'Oxymoron'], a: 0 },
  { q: 'Which country’s flag is the only national flag that is not rectangular?', choices: ['Nepal', 'Bhutan', 'Switzerland', 'Sri Lanka'], a: 0 },
  { q: 'What is the largest internal organ in the human body?', choices: ['Lung', 'Liver', 'Kidney', 'Heart'], a: 1 },
  { q: 'Which metal is liquid at room temperature?', choices: ['Gallium', 'Mercury', 'Sodium', 'Cesium'], a: 1 },
  { q: 'Which physicist proposed the uncertainty principle?', choices: ['Niels Bohr', 'Werner Heisenberg', 'Max Planck', 'Erwin Schrödinger'], a: 1 },
  { q: 'What is the name of the strait separating Europe and Africa at the Mediterranean entrance?', choices: ['Bosphorus', 'Strait of Gibraltar', 'Dardanelles', 'Strait of Hormuz'], a: 1 },
  { q: 'Which desert is the largest hot desert on Earth?', choices: ['Gobi', 'Sahara', 'Arabian', 'Kalahari'], a: 1 },
  { q: 'Which is the smallest country in the world by area?', choices: ['Monaco', 'Vatican City', 'San Marino', 'Liechtenstein'], a: 1 },
  { q: 'What is the study of mushrooms called?', choices: ['Botany', 'Mycology', 'Entomology', 'Ornithology'], a: 1 },
  { q: 'Which chemical element is named after the Greek word for “green”?', choices: ['Chlorine', 'Neon', 'Nickel', 'Copper'], a: 0 },
  { q: 'What is the largest planet in our Solar System?', choices: ['Saturn', 'Jupiter', 'Neptune', 'Uranus'], a: 1 },
  { q: 'What is the capital of Canada?', choices: ['Toronto', 'Ottawa', 'Montreal', 'Vancouver'], a: 1 },
  { q: 'Which organelle is known as the “powerhouse of the cell”?', choices: ['Nucleus', 'Mitochondria', 'Ribosome', 'Golgi apparatus'], a: 1 },
  { q: 'What does “HTTP” stand for?', choices: ['HyperText Transfer Protocol', 'High Transfer Text Program', 'Hyperlink Transmission Process', 'Host Transfer Protocol'], a: 0 },
  { q: 'In what city would you find the Acropolis?', choices: ['Rome', 'Athens', 'Istanbul', 'Cairo'], a: 1 },
  { q: 'Which country is the origin of the word “robot”?', choices: ['Germany', 'Czech Republic', 'Japan', 'Russia'], a: 1 },
  { q: 'Which scientist developed the polio vaccine first widely used in the 1950s?', choices: ['Louis Pasteur', 'Jonas Salk', 'Alexander Fleming', 'Gregor Mendel'], a: 1 },
  { q: 'Which of these is NOT a Nobel Prize category?', choices: ['Physics', 'Chemistry', 'Mathematics', 'Literature'], a: 2 },
  { q: 'Which sea is the saltiest major body of water (hyper-saline lake)?', choices: ['Caspian Sea', 'Dead Sea', 'Red Sea', 'Black Sea'], a: 1 },
  { q: 'What is the main ingredient in traditional Japanese miso?', choices: ['Rice', 'Soybeans', 'Seaweed', 'Buckwheat'], a: 1 },
  { q: 'Which telescope launched in 1990 has provided deep-space images for decades?', choices: ['Kepler', 'Hubble Space Telescope', 'Spitzer', 'Chandra'], a: 1 },
  { q: 'Which mountain is the tallest in the world above sea level?', choices: ['K2', 'Mount Everest', 'Kangchenjunga', 'Lhotse'], a: 1 },
  { q: 'What is the name of the largest artery in the human body?', choices: ['Carotid', 'Aorta', 'Femoral', 'Pulmonary artery'], a: 1 },
  { q: 'Which artist painted the ceiling of the Sistine Chapel?', choices: ['Raphael', 'Michelangelo', 'Leonardo da Vinci', 'Donatello'], a: 1 },
  { q: 'What is the largest desert on Earth by area?', choices: ['Sahara', 'Antarctic Desert', 'Arctic Desert', 'Gobi'], a: 1 },
  { q: 'Which country is home to the ancient city of Petra?', choices: ['Jordan', 'Egypt', 'Greece', 'Turkey'], a: 0 },
  { q: 'Which planet is known for its prominent ring system?', choices: ['Mars', 'Saturn', 'Mercury', 'Venus'], a: 1 },
  { q: 'What is the name of the line that divides Earth into Northern and Southern Hemispheres?', choices: ['Prime Meridian', 'Equator', 'Tropic of Cancer', 'International Date Line'], a: 1 },
  { q: 'Which author wrote “Frankenstein”?', choices: ['Mary Shelley', 'Bram Stoker', 'Jane Austen', 'Emily Brontë'], a: 0 },
  { q: 'Which language has the most native speakers worldwide?', choices: ['English', 'Mandarin Chinese', 'Spanish', 'Hindi'], a: 1 },
  { q: 'What is the term for molten rock beneath Earth’s surface?', choices: ['Lava', 'Magma', 'Basalt', 'Quartz'], a: 1 },
  { q: 'Which blood type is known as the universal donor (red cells)?', choices: ['A+', 'AB+', 'O−', 'O+'], a: 2 },
  { q: 'Which country invented the printing press with movable metal type in Europe?', choices: ['Italy', 'Germany', 'France', 'Netherlands'], a: 1 },
  { q: 'What is the square root of 144?', choices: ['10', '11', '12', '13'], a: 2 },
  { q: 'Which instrument measures atmospheric pressure?', choices: ['Thermometer', 'Barometer', 'Hygrometer', 'Anemometer'], a: 1 },
  { q: 'Which of these is a Shakespeare tragedy?', choices: ['Twelfth Night', 'Much Ado About Nothing', 'Hamlet', 'A Midsummer Night’s Dream'], a: 2 },
  { q: 'What is the process by which plants make food using sunlight?', choices: ['Respiration', 'Fermentation', 'Photosynthesis', 'Transpiration'], a: 2 },
  { q: 'Which country has the city of Marrakech?', choices: ['Morocco', 'Spain', 'Portugal', 'Tunisia'], a: 0 },
  { q: 'What is the name for animals that eat both plants and meat?', choices: ['Herbivores', 'Carnivores', 'Omnivores', 'Detritivores'], a: 2 },
  { q: 'Which is the only continent without reptiles or snakes?', choices: ['Europe', 'Antarctica', 'Australia', 'South America'], a: 1 },
  { q: 'What is the capital of New Zealand?', choices: ['Auckland', 'Wellington', 'Christchurch', 'Dunedin'], a: 1 },
  { q: 'Which element’s symbol is “Na”?', choices: ['Neon', 'Nitrogen', 'Sodium', 'Nickel'], a: 2 },
];
